  ...
  return (
    <div className={Styles.portfolio_content}>
      ...
      <div className={Styles.portfolio_group}>
        ...
        <img src={Youpet} alt="Guitar_Code" className={Styles.portfolio_img} onClick={()=> clickImage(1)}/>
        ...
        <div>
          ...
          <div className={modal === 1 ? Styles.portfolio_modal_active : Styles.portfolio_modal}>
            ...
            <div className={Styles.portfolio_modal_content}>
                ...
                <h3 className={Styles.porftolio_modal_text}>App para sacar turnos para tu mascota con tu veterinario favorito.</h3>
            </div>
          </div> 
        ...
        <div>
          ...
          <div className={modal === 2 ? Styles.portfolio_modal_active : Styles.portfolio_modal}>
            ...
            <div className={Styles.portfolio_modal_content}>
              ...
              <h3 className={Styles.porftolio_modal_text}>SPA sobre listado y busqueda de Pokemons</h3>
            </div>
          </div>
